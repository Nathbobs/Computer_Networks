...
func getNonce() string { // getNonce generates a nonce value based on the current time in milliseconds.
...
// sign computes the HMAC signature for the request using the private key and message.
...
// mapToURLValues converts a map of string keys to values into url.Values format.
